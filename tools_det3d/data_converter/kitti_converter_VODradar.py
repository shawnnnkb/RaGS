...
from .kitti_data_utils_VOD import get_kitti_image_info, get_waymo_image_info
...
def _calculate_num_points_in_gt(data_path,
                                ...
                                relative_path,
                                remove_outside=True,
                                num_features=7):  # lidar-4 vod-7 TJ4D-8
...
def create_kitti_info_file(data_path,
    ...
    # print(f'Kitti info val_small file is saved to {filename}')

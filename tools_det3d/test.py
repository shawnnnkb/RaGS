...
import shutil
# import sys
# sys.path.remove('/home/bxk/CODE-40903-PhD-2/RaGS')
...
from tools_det3d.train import load_pretrained_model
import faulthandler
faulthandler.enable()
# os.environ['CUDA_LAUNCH_BLOCKING'] = '1'
# './projects/RadarGS/checkpoints/vod-radarpillarnet_modified_4x1_80e/epoch_80.pth'

def parse_args():
    parser = argparse.ArgumentParser(description='MMDet test (and eval) a model')
    parser.add_argument('--config', default='./projects/RadarGS/configs/vod-RadarGS_4x4_24e_detect3d.py', help='test config file path')
    parser.add_argument('--checkpoint', default='./projects/RadarGS/checkpoints/detections_on_VoD.pth', help='checkpoint file')

...
class Evaluation:
    ...
    def evaluate(self,
        ...
        evaluation_result = {}
        evaluation_result.update(get_official_eval_result(gt_annotations, dt_annotations, current_class, AP=11, custom_method=0))
        evaluation_result.update(get_official_eval_result(gt_annotations, dt_annotations, current_class, AP=11, custom_method=3))
        evaluation_result.update(get_official_eval_result(gt_annotations, dt_annotations, current_class, AP=11, custom_method=4))
